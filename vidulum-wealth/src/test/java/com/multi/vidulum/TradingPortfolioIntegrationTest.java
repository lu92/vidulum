...
class TradingPortfolioIntegrationTest extends WealthIntegrationTest {
    ...
    void shouldBuyBitcoinTest() {
        ...
        Portfolio expectedPortfolio = Portfolio.builder()
                ...
                .assets(List.of(
                        Asset.builder()
                                ...
                                .costBasis(CostBasis.of(Quantity.of(40000), Price.one("USD"), Provenance.ASSUMED_PAR))
                        ...
                        "Crypto", List.of(
                                PortfolioDto.AssetSummaryJson.builder()
                                        ...
                                        .costBasis(PortfolioDto.CostBasisJson.builder()
                                                .quantity(Quantity.of(1))
                                                .avgPrice(Price.of(60000.0, "USD"))
                                                .provenance(Provenance.DERIVED_FROM_FILLS)
                                                .build())
                                        .quantity(Quantity.of(1))
                                        .locked(Quantity.zero())
                                        .free(Quantity.of(1))
                        ...
                        "Cash", List.of(
                                PortfolioDto.AssetSummaryJson.builder()
                                        ...
                                        .costBasis(PortfolioDto.CostBasisJson.builder()
                                                ...
                                                .avgPrice(Price.one("USD"))
                                                .provenance(Provenance.ASSUMED_PAR)
                                                .build())
                                        .quantity(Quantity.of(40000.0))
                                        .locked(Quantity.zero())
                                        .activeLocks(Set.of())
        ...
        PortfolioDto.AggregatedPortfolioSummaryJson expectedAggregatedPortfolio2 = PortfolioDto.AggregatedPortfolioSummaryJson.builder()
                        ...
                        "Crypto", List.of(
                                PortfolioDto.AssetSummaryJson.builder()
                                        ...
                                        .costBasis(PortfolioDto.CostBasisJson.builder()
                                                ...
                                                // C1: the average purchase price no longer absorbs sale proceeds.
                                                // The old rule subtracted what a partial sale fetched from the
                                                // remaining position's cost, so the realised gain was reported
                                                // twice - once as trade profit and again as unrealised profit on
                                                // what was left. What you paid does not change because you sold
                                                // part of it.
                                                .avgPrice(Price.of(60000.0, "USD"))
                                                .provenance(Provenance.DERIVED_FROM_FILLS)
                                                .build())
                ...
                // po prostu nie nalezy do tej liczby, jej miejsce jest w module PnL.
                .totalUnrealisedProfit(Money.zero("USD"))
                .pctUnrealisedProfit(0.0)
                .profitCoverage(1.0)
                .profitStatus(ProfitStatus.COMPUTED)
        ...
        Portfolio expectedPortfolio = Portfolio.builder()
                ...
                .assets(List.of(
                        Asset.builder()
                                .ticker(Ticker.of("USD"))
                                .subName(SubName.none())
                                .costBasis(CostBasis.of(Quantity.of(120000), Price.one("USD"), Provenance.ASSUMED_PAR))
    ...
    void shouldExecuteTrades() {
        ...
        Portfolio expectedPortfolio = Portfolio.builder()
                ...
                .assets(List.of(
                        Asset.builder()
                                .ticker(Ticker.of("USD"))
                                .subName(SubName.none())
                                .costBasis(CostBasis.of(Quantity.of(87100), Price.one("USD"), Provenance.ASSUMED_PAR))
        ...
        PortfolioDto.AggregatedPortfolioSummaryJson expectedAggregatedPortfolio = PortfolioDto.AggregatedPortfolioSummaryJson.builder()
                ...
                .segmentedAssets(Map.of("Cash", List.of(
                        ...
                        "Crypto", List.of(
                                PortfolioDto.AssetSummaryJson.builder()
                                        ...
                                        .costBasis(PortfolioDto.CostBasisJson.builder()
                                                .quantity(Quantity.of(1.3))
                                                .avgPrice(Price.of(3000.0000, "USD"))
                                                .provenance(Provenance.DERIVED_FROM_FILLS)
                                                .build())
                                        .quantity(Quantity.of(1.3))
                                        .locked(Quantity.zero())
                                        .free(Quantity.of(1.3))
                                        .activeLocks(Set.of())
                                        .pctUnrealisedProfit(-0.05)
                                        .unrealisedProfit(Money.of(-195.0000, "USD"))
                                        .coverage(1.0)
                                ...
                                PortfolioDto.AssetSummaryJson.builder()
                                        ...
                                        .free(Quantity.of(0.25))
                                        .activeLocks(Set.of())
                                        .pctUnrealisedProfit(0.6)
                                        .unrealisedProfit(Money.of(5625.0, "USD"))
                                        .coverage(1.0)
                ...
                .totalUnrealisedProfit(Money.of(5430.0, "USD"))
                ...
                .segmentedAssets(Map.of(
                        ...
                        "Precious Metals", List.of(
                                PortfolioDto.AssetSummaryJson.builder()
                                        ...
                                        .activeLocks(Set.of())
                                        .pctUnrealisedProfit(0.05555555)
                                        .unrealisedProfit(Money.of(25, "USD"))
                                        .coverage(1.0)
                                ...
                                PortfolioDto.AssetSummaryJson.builder()
                                        ...
                                        .costBasis(PortfolioDto.CostBasisJson.builder()
                                                ...
                                                // C1: see the note on BTC above - cost no longer absorbs sale proceeds.
                                                .avgPrice(Price.of(1857.5, "USD"))
                                                .provenance(Provenance.DERIVED_FROM_FILLS)
                                                .build())
                                        .quantity(Quantity.of(4, "oz"))
                                        .locked(Quantity.of(0, "oz"))
                                        ...
                                        .activeLocks(Set.of())
                                        .pctUnrealisedProfit(-0.03095559)
                                        .unrealisedProfit(Money.of(-230.0, "USD"))
                                        .coverage(1.0)
