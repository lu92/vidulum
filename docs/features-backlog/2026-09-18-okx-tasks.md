...
| **G6** | P2 | Wyjątki portfela zwracają 500 zamiast swoich kodów | — |
...
| **G2** | P1 | **finished** | Kontrola własności na endpointach portfela i transakcji | — | — |
| **G6** | P2 | `open` | Wyjątki portfela zwracają 500 zamiast swoich kodów | — | — |
...
flowchart LR
    ...
    G6["G6 Wyjątki portfela zwracają 500 zamiast…"]:::p2
