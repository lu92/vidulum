...
| **C15** | P1 | `AssetSummaryJson` nie mówi, która to pozycja | — |
...
| **C15** | P1 | `open` | `AssetSummaryJson` nie mówi, która to pozycja | C2 | — |
...
flowchart LR
    ...
    C15["C15 AssetSummaryJson nie mówi, która to…"]:::p1
