...
| **C5** | P1 | Zmiana wartości majątku | — |
| **C6** | P1 | Naprawa `AggregatedPortfolio` | — |
| **C9** | P1 | `investedBalance` przy tworzeniu ze spec-u | — |
...
| **G2** | P1 | Kontrola własności na endpointach portfela i transakcji | — |
| **G3** | P1 | Zaszyte `USD` w kliencie portfela i `Order.getTotal()` | — |
...
| **G5** | P2 | Wpłata kasuje blokadę na gotówce | — |
...
| **D3** | P0 | **finished** | Zatwierdzenie i utworzenie portfela | D2 | C9, D5, D8, D11, D12, E4 |
...
| **E3** | P0 | **finished** | Zebranie snapshotu do spec-u | E2 | E4 |
...
| **G2** | P1 | `open` | Kontrola własności na endpointach portfela i transakcji | — | — |
| **G3** | P1 | `open` | Zaszyte `USD` w kliencie portfela i `Order.getTotal()` | — | — |
| **G4** | P2 | `open` | `Quantity` bez kontroli jednostek | — | — |
| **G5** | P2 | `open` | Wpłata kasuje blokadę na gotówce | — | — |
...
flowchart LR
    ...
    C9["C9 investedBalance przy tworzeniu ze s…"]:::p1
    ...
    G2["G2 Kontrola własności na endpointach por…"]:::p1
    G3["G3 Zaszyte USD w kliencie portfela i …"]:::p1
    G4["G4 Quantity bez kontroli jednostek"]:::p2
    G5["G5 Wpłata kasuje blokadę na gotówce"]:::p2
