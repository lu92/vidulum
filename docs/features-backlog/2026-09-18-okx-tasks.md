...
|---|---|---|---|
| **C10** | P0 | Gotówka ze snapshotu trafia do `transferred-in`, nie do `none` | — |
| **A7** | P1 | Ponowne podłączenie po przerwie | — |
| **C3** | P1 | Wynik tylko ze znanej części | C4 |
...
| **C10** | P0 | `open` | Gotówka ze snapshotu trafia do `transferred-in`, nie do `none` | C2, D1 | — |
...
| **D3** | P0 | **finished** | Zatwierdzenie i utworzenie portfela | D2 | C9, D5, D8, D11, E4 |
...
| **E4** | P0 | **finished** | Przejście ścieżki spec-u | A8, D3, E3 | E5, E7 |
| **E5** | P1 | **finished** | Publikacja notowań | B3, E4 | E6 |
| **E6** | P1 | **finished** | Pętla odświeżania | E5 | — |
| **E7** | P1 | **finished** | Odczyt i prezentacja wyceny | E4, E8 | — |
...
flowchart LR
    ...
    A8["A8 Onboarding polaczenia — serwis i endpoint"]:::done
    A9["A9 Odczyt stanu polaczenia"]:::done
