...
export const ORDER_FIELDS = {
  accFillSz: { group: "execution", verified: true, example: "0",
    docs: "Accumulated fill quantity. The unit is base_ccy for SPOT and MARGIN; for market orders the unit is base_ccy whether tgtCcy is base_ccy or quote_ccy; the unit is contract for FUTURES/SWAP/OPTION.",
    observed: ["0", "0.0002"],
    documented: null,
    note: "Cumulative filled size across every fill of this order." },
  algoClOrdId: { group: "identity", verified: false, example: null,
    docs: "Client-supplied Algo ID. There will be a value when an algo order attaching algoClOrdId is triggered, otherwise \"\".",
    observed: [],
    documented: null,
    note: "Client id of the algo order that created this one." },
  algoId: { group: "identity", verified: false, example: null,
    docs: "Algo ID. There will be a value when an algo order is triggered, otherwise \"\".",
    observed: [],
    documented: null,
  ...
  amendResult: { group: "amend", verified: true, example: "0",
    docs: "The result of amending the order. Returns \"\" when cxlOnFail is true and the amendment is rejected.",
    observed: ["0"],
    documented: ["-1", "0", "1", "2"],
  ...
  amendSource: { group: "amend", verified: true, example: "1",
    docs: "Source of the order amendment.",
    observed: ["1"],
  ...
  attachAlgoClOrdId: { group: "protection", verified: false, example: null,
    docs: "Client-supplied Algo ID when placing order with attached TP/SL or trailing stop.",
    observed: [],
    documented: null,
    note: "Client id of the attached algo order." },
  attachAlgoOrds: { group: "protection", verified: true, example: "(object)",
    docs: "Attached TP/SL or trailing stop order information.",
    observed: [],
    documented: null,
  ...
  avgPx: { group: "execution", verified: true, example: "0",
    docs: "Average filled price. If none is filled, it will return 0.",
    observed: ["0", "66588.7"],
    documented: null,
    note: "Average fill price across every fill." },
  cTime: { group: "meta", verified: true, example: "1789240636555",
    docs: "Creation time, Unix timestamp format in milliseconds.",
  ...
  cancelSource: { group: "cancel", verified: true, example: "1",
    docs: "Source of the order cancellation.",
    observed: ["1"],
  ...
  ccy: { group: "instrument", verified: true, example: "EUR",
    docs: "Margin currency. Applicable to all isolated MARGIN orders and cross MARGIN orders in Futures mode, FUTURES and SWAP contracts.",
    observed: ["EUR"],
    documented: null,
    note: "Margin currency. On spot it mirrors the quote currency." },
  clOrdId: { group: "identity", verified: false, example: null,
    docs: "Client Order ID as assigned by the client.",
    observed: [],
    documented: null,
    note: "Client-supplied order id. Empty unless you set one when placing the order." },
  code: { group: "amend", verified: true, example: "0",
    docs: "Error code, the default is 0.",
    observed: ["0"],
    documented: null,
    note: "Error code when an amend or the order itself failed; 0 otherwise." },
  execType: { group: "execution", verified: true, example: "T",
    docs: "Liquidity taker or maker for the current update. T: taker, M: maker.",
    observed: ["T"],
    documented: ["T", "M"],
    note: "T = taker, M = maker." },
  fee: { group: "fees", verified: true, example: "0",
    docs: "Fee amount. For Spot and Margin excluding maker sell orders: accumulated fee charged by the platform, always negative. For maker sell orders in Spot and Margin, Expiry Futures, Perpetual Futures and Options: accumulated fee and rebate.",
  ...
  feeCcy: { group: "fees", verified: true, example: "BTC",
    docs: "Fee currency. For maker sell orders of Spot and Margin this represents the quote currency. For all other cases it represents the currency in which fees are charged.",
    observed: ["BTC"],
    documented: null,
    note: "Currency the cumulative fee is charged in." },
  fillFee: { group: "fees", verified: true, example: "0",
    docs: "Filled fee amount or rebate amount for the current update. Negative represents the transaction fee charged by the platform; positive represents rebate.",
    observed: ["-0.0000007", "0"],
    documented: null,
    note: "Fee for THIS fill only." },
  fillFeeCcy: { group: "fees", verified: true, example: "BTC",
    docs: "Filled fee currency or rebate currency for the current update. Fee currency when fillFee is less than 0; rebate currency when fillFee >= 0.",
    observed: ["BTC"],
    documented: null,
    note: "Currency of this fill's fee." },
  fillFwdPx: { group: "execution", verified: false, example: null,
    docs: "Forward price when filled. Only applicable to options.",
    observed: [],
    documented: null,
    note: "Forward price at fill time (options)." },
  fillIdxPx: { group: "execution", verified: true, example: "77356.8",
    docs: "Index price at the moment of trade execution. For cross currency spot pairs it returns the baseCcy-USDT index price (e.g. for LTC-ETH it returns the LTC-USDT index price).",
    observed: ["77356.8"],
    documented: null,
  ...
  fillPxUsd: { group: "execution", verified: false, example: null,
    docs: "Options price when filled, in the unit of USD. Only applicable to options.",
    observed: [],
    documented: null,
    note: "Fill price in USD (options)." },
  fillPxVol: { group: "execution", verified: false, example: null,
    docs: "Implied volatility when filled. Only applicable to options.",
    observed: [],
    documented: null,
    note: "Fill price as implied volatility (options)." },
  fillSz: { group: "execution", verified: true, example: "0",
    docs: "Filled quantity for the current update. The unit is base_ccy for SPOT and MARGIN; for market orders the unit is base_ccy whether tgtCcy is base_ccy or quote_ccy; the unit is contract for FUTURES/SWAP/OPTION.",
    observed: ["0", "0.0002"],
    documented: null,
    note: "Size of THIS fill only." },
  fillTime: { group: "execution", verified: true, example: "1789240740102",
    docs: "Filled time for the current update.",
  ...
  isTpLimit: { group: "protection", verified: true, example: "false",
    docs: "Whether it is a TP limit order. true or false.",
    observed: ["false"],
  ...
  lever: { group: "terms", verified: true, example: "0",
    docs: "Leverage, from 0.01 to 125. Only applicable to MARGIN/FUTURES/SWAP.",
    observed: ["0"],
    documented: null,
  ...
  linkedAlgoOrd: { group: "protection", verified: true, example: "(object)",
    docs: "Linked SL order detail, only applicable to the TP limit order of a one-cancels-the-other order (oco).",
    observed: [],
    documented: null,
  ...
  outcome: { group: "cancel", verified: false, example: null,
    docs: "The market outcome the user traded on: yes or no. Only applicable to EVENTS.",
    observed: [],
    documented: ["yes", "no"],
    note: "Outcome classification supplied by OKX." },
  pnl: { group: "fees", verified: true, example: "0",
    docs: "Profit and loss excluding the fee. Applicable to orders which have a trade and aim to close position; always 0 in other conditions. For liquidation under cross margin mode it includes liquidation penalties.",
    observed: ["0"],
    documented: null,
    note: "Cumulative realised PnL for the order." },
  posSide: { group: "terms", verified: false, example: null,
    docs: "Position side. net; long or short only applicable to FUTURES/SWAP.",
    observed: [],
    documented: ["net", "long", "short"],
    note: "Position side for derivatives; empty on spot." },
  px: { group: "terms", verified: true, example: "50000",
    docs: "Price. For options, use coin as unit (e.g. BTC, ETH).",
    observed: ["50000", "51000", "66700"],
    documented: null,
    note: "Limit price. Empty for market orders." },
  pxType: { group: "terms", verified: false, example: null,
    docs: "Price type of options: px (in the unit of coin), pxVol, or pxUsd (in the unit of USD).",
    observed: [],
  ...
  pxUsd: { group: "terms", verified: false, example: null,
    docs: "Options price in USD. Only applicable to options; returns \"\" for other instrument types.",
    observed: [],
    documented: null,
    note: "Options only - price in USD." },
  pxVol: { group: "terms", verified: false, example: null,
    docs: "Implied volatility of the options order. Only applicable to options; returns \"\" for other instrument types.",
    observed: [],
    documented: null,
    note: "Options only - price expressed as implied volatility." },
  quickMgnType: { group: "terms", verified: false, example: null,
    docs: "Quick Margin type, only applicable to Quick Margin Mode of isolated margin: manual, auto_borrow, auto_repay. Deprecated.",
    observed: [],
  ...
  rebate: { group: "fees", verified: true, example: "0",
    docs: "Rebate amount, only applicable to Spot and Margin. For maker sell orders: accumulated fee and rebate amount in the unit of base currency. For all other cases the maker rebate amount, always positive; returns \"\" if no rebate.",
    observed: ["0"],
    documented: null,
    note: "Cumulative rebate." },
  rebateCcy: { group: "fees", verified: true, example: "EUR",
    docs: "Rebate currency. For maker sell orders of Spot and Margin this represents the base currency. For all other cases it represents the currency in which rebates are paid.",
    observed: ["EUR"],
    documented: null,
    note: "Rebate currency." },
  reduceOnly: { group: "terms", verified: true, example: "false",
    docs: "Whether the order can only reduce the position size. true or false.",
    observed: ["false"],
    documented: ["true", "false"],
    note: "Derivatives only - the order may only reduce a position." },
  reqId: { group: "identity", verified: false, example: null,
    docs: "Client Request ID as assigned by the client for order amendment. Returns \"\" if there is no order amendment.",
    observed: [],
    documented: null,
    note: "Echo of the amend request id, when the amend supplied one." },
  side: { group: "terms", verified: true, example: "buy",
    docs: "Order side, buy or sell.",
    observed: ["buy"],
    documented: ["buy", "sell"],
    note: "buy | sell." },
  slOrdPx: { group: "protection", verified: false, example: null,
    docs: "Stop-loss order price.",
    observed: [],
    documented: null,
    note: "Legacy stop-loss order price. -1 means execute at market." },
  slTriggerPx: { group: "protection", verified: false, example: null,
    docs: "Stop-loss trigger price.",
    observed: [],
    documented: null,
  ...
  slTriggerPxType: { group: "protection", verified: false, example: null,
    docs: "Stop-loss trigger price type: last, index or mark price.",
    observed: [],
  ...
  source: { group: "cancel", verified: false, example: null,
    docs: "Order source - which kind of order triggered this normal order.",
    observed: [],
  ...
  stpId: { group: "terms", verified: false, example: null,
    docs: "Self trade prevention ID. Returns \"\" if self trade prevention is not applicable. Deprecated.",
    observed: [],
    documented: null,
  ...
  tdMode: { group: "terms", verified: true, example: "cash",
    docs: "Trade mode: cross, isolated, cash.",
    observed: ["cash"],
    documented: ["cross", "isolated", "cash"],
    note: "cash | cross | isolated. Spot uses cash." },
  tgtCcy: { group: "terms", verified: false, example: null,
    docs: "Order quantity unit setting for sz: base_ccy or quote_ccy. Only applicable to SPOT market orders. Default is quote_ccy for buy, base_ccy for sell.",
    observed: [],
