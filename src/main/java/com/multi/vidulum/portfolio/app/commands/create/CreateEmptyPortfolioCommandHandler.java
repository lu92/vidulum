...
@Component
@AllArgsConstructor
public class CreateEmptyPortfolioCommandHandler implements CommandHandler<CreateEmptyPortfolioCommand, PortfolioId> {

    private final DomainPortfolioRepository repository;
    private final PortfolioFactory portfolioFactory;

    @Override
    public PortfolioId handle(CreateEmptyPortfolioCommand command) {
        ...
        log.info("New portfolio for user [{}] has been created!", command.getUserId());
